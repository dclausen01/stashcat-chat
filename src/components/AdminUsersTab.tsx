/**
 * Tab „Nutzer" im Admin-Bereich.
 *
 * Company-Kontext und Rechte kommen von `AdminView`, das die Tabs verwaltet.
 * Die Rechtepruefungen hier blenden nur UI aus — autorisiert wird serverseitig
 * in `server/lib/admin.ts`.
 */

import { useCallback, useEffect, useMemo, useRef, useState } from 'react';
import {
  Plus, Search, Loader2, ShieldCheck, PenOff,
...
export default function AdminUsersTab({ companyId, has }: AdminUsersTabProps) {
